...
a circle on screen that will represent a lightbuld. Whith the marker you can
...
then disapears the light "turns off"showing a black circle again.


If tha camera can se the marker an the marker is turned clockwise the hue or 
